...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRSlider : XRBaseInteractable
    {
        ...
        void Start()
        {
            ...
            Debug.Log($"Slider Interaction Layer Mask: {interactionLayers.value}");
        }
        ...
        void StartGrab(SelectEnterEventArgs args)
        {
            ...
            Debug.Log($"Start grab. Interactor: {m_Interactor.transform.name}, Side: {(m_Interactor.transform.name.Contains("Left") ? "Left" : "Right")}");
